...
export const SimulationDashboard = memo(function SimulationDashboard() {
  ...
  return (
    <div className="pointer-events-auto absolute left-4 right-4 top-4 z-30 flex flex-wrap items-center gap-2 rounded-xl border border-border bg-background/90 px-4 py-2 shadow-lg backdrop-blur-sm">
      {/* Metric pills */}
      <MetricPill
        icon={Activity}
        label="RPS"
