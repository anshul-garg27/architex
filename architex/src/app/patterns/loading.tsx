/**
 * Patterns route loading skeleton — header + search + grouped card grid
 * matching PatternsIndexPage layout.
  ...
  return (
    <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
      <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        {/* Pattern category groups (3 categories: Creational, Structural, Behavioral) */}
