  ...
  classes: [
    {
      ...
      stereotype: "class",
      attributes: [
        { id: "singleton-class-attr-0", name: "instance", type: "DatabaseConnectionPool", visibility: "-" },
        { id: "singleton-class-attr-1", name: "connections", type: "Connection[]", visibility: "-" },
        { id: "singleton-class-attr-2", name: "maxPoolSize", type: "number", visibility: "-" },
      ],
      methods: [
        { id: "singleton-class-meth-0", name: "constructor", returnType: "void", params: [], visibility: "-" },
        { id: "singleton-class-meth-1", name: "getInstance", returnType: "DatabaseConnectionPool", params: [], visibility: "+" },
        { id: "singleton-class-meth-2", name: "getConnection", returnType: "Connection", params: [], visibility: "+" },
        { id: "singleton-class-meth-3", name: "releaseConnection", returnType: "void", params: ["conn: Connection"], visibility: "+" },
        { id: "singleton-class-meth-4", name: "getActiveCount", returnType: "number", params: [], visibility: "+" },
      ],
      x: 200,
      y: 100,
    },
...
const factoryMethod: DesignPattern = {
  ...
  classes: [
    {
      ...
      attributes: [],
      methods: [
        { id: "fm-notification-meth-0", name: "send", returnType: "void", params: ["recipient: string"], visibility: "+" },
        { id: "fm-notification-meth-1", name: "getChannel", returnType: "string", params: [], visibility: "+" },
      ],
      x: 400,
      y: 50,
    },
    {
      id: "fm-email-notification",
      name: "EmailNotification",
      stereotype: "class",
      attributes: [
        { id: "fm-email-notification-attr-0", name: "subject", type: "string", visibility: "-" },
        { id: "fm-email-notification-attr-1", name: "body", type: "string", visibility: "-" },
      ],
      methods: [
        { id: "fm-email-notification-meth-0", name: "send", returnType: "void", params: ["recipient: string"], visibility: "+" },
        { id: "fm-email-notification-meth-1", name: "getChannel", returnType: "string", params: [], visibility: "+" },
      ],
      x: 250,
      y: 220,
    },
    {
      id: "fm-sms-notification",
      name: "SMSNotification",
      stereotype: "class",
      attributes: [
        { id: "fm-sms-notification-attr-0", name: "phoneNumber", type: "string", visibility: "-" },
        { id: "fm-sms-notification-attr-1", name: "message", type: "string", visibility: "-" },
      ],
      methods: [
        { id: "fm-sms-notification-meth-0", name: "send", returnType: "void", params: ["recipient: string"], visibility: "+" },
        { id: "fm-sms-notification-meth-1", name: "getChannel", returnType: "string", params: [], visibility: "+" },
      ],
      x: 550,
      y: 220,
    },
  ...
  relationships: [
    { id: rid(), source: "fm-email-notification", target: "fm-notification", type: "realization" },
    { id: rid(), source: "fm-sms-notification", target: "fm-notification", type: "realization" },
    { id: rid(), source: "fm-email-factory", target: "fm-factory", type: "inheritance" },
    { id: rid(), source: "fm-sms-factory", target: "fm-factory", type: "inheritance" },
    { id: rid(), source: "fm-factory", target: "fm-notification", type: "dependency", label: "creates" },
  ],
  code: {
...
const builder: DesignPattern = {
  ...
  classes: [
    {
      ...
      attributes: [],
      methods: [
        { id: "b-query-builder-meth-0", name: "reset", returnType: "void", params: [], visibility: "+" },
        { id: "b-query-builder-meth-1", name: "select", returnType: "QueryBuilder", params: ["fields: string[]"], visibility: "+" },
        { id: "b-query-builder-meth-2", name: "where", returnType: "QueryBuilder", params: ["condition: string"], visibility: "+" },
        { id: "b-query-builder-meth-3", name: "orderBy", returnType: "QueryBuilder", params: ["field: string", "dir: string"], visibility: "+" },
        { id: "b-query-builder-meth-4", name: "limit", returnType: "QueryBuilder", params: ["count: number"], visibility: "+" },
        { id: "b-query-builder-meth-5", name: "build", returnType: "Query", params: [], visibility: "+" },
      ],
      x: 100,
      y: 50,
    },
    {
      ...
      stereotype: "class",
      attributes: [
        { id: "b-sql-builder-attr-0", name: "query", type: "Query", visibility: "-" },
        { id: "b-sql-builder-attr-1", name: "tableName", type: "string", visibility: "-" },
      ],
      methods: [
        { id: "b-sql-builder-meth-0", name: "reset", returnType: "void", params: [], visibility: "+" },
        { id: "b-sql-builder-meth-1", name: "select", returnType: "QueryBuilder", params: ["fields: string[]"], visibility: "+" },
        { id: "b-sql-builder-meth-2", name: "where", returnType: "QueryBuilder", params: ["condition: string"], visibility: "+" },
        { id: "b-sql-builder-meth-3", name: "orderBy", returnType: "QueryBuilder", params: ["field: string", "dir: string"], visibility: "+" },
        { id: "b-sql-builder-meth-4", name: "limit", returnType: "QueryBuilder", params: ["count: number"], visibility: "+" },
        { id: "b-sql-builder-meth-5", name: "build", returnType: "Query", params: [], visibility: "+" },
      ],
      x: 100,
      y: 280,
    },
    {
      ...
      stereotype: "class",
      attributes: [
        { id: "b-query-attr-0", name: "queryString", type: "string", visibility: "-" },
        { id: "b-query-attr-1", name: "params", type: "unknown[]", visibility: "-" },
      ],
      methods: [
        { id: "b-query-meth-0", name: "execute", returnType: "Promise<Row[]>", params: [], visibility: "+" },
        { id: "b-query-meth-1", name: "toString", returnType: "string", params: [], visibility: "+" },
      ],
      x: 400,
      y: 280,
    },
    {
      ...
      methods: [
        ...
        { id: "b-director-meth-1", name: "buildSimpleSelect", returnType: "void", params: [], visibility: "+" },
        { id: "b-director-meth-2", name: "buildPaginatedQuery", returnType: "void", params: [], visibility: "+" },
      ],
      x: 400,
      y: 50,
    },
  ...
  relationships: [
    { id: rid(), source: "b-sql-builder", target: "b-query-builder", type: "realization" },
    { id: rid(), source: "b-director", target: "b-query-builder", type: "association", label: "uses" },
    { id: rid(), source: "b-sql-builder", target: "b-query", type: "dependency", label: "creates" },
  ],
  code: {
  ...
  classes: [
    {
      ...
      attributes: [],
      methods: [
        { id: "a-json-parser-meth-0", name: "parseJSON", returnType: "Record<string, unknown>", params: ["data: string"], visibility: "+" },
        { id: "a-json-parser-meth-1", name: "isValid", returnType: "boolean", params: ["data: string"], visibility: "+" },
      ],
      x: 100,
      y: 100,
    },
    {
      id: "a-xml-to-json-adapter",
      name: "XMLToJSONAdapter",
      stereotype: "class",
      attributes: [
      ...
      methods: [
        ...
        { id: "a-xml-to-json-adapter-meth-1", name: "isValid", returnType: "boolean", params: ["data: string"], visibility: "+" },
        { id: "a-xml-to-json-adapter-meth-2", name: "convertToJSON", returnType: "string", params: ["xml: string"], visibility: "-" },
      ],
      x: 350,
      y: 100,
    },
    {
      ...
      methods: [
        ...
        { id: "a-xml-parser-meth-1", name: "validate", returnType: "boolean", params: ["data: string"], visibility: "+" },
      ],
      x: 600,
      y: 100,
    },
...
const decorator: DesignPattern = {
  ...
  classes: [
    {
      ...
      attributes: [],
      methods: [
        { id: "d-data-stream-meth-0", name: "read", returnType: "Buffer", params: [], visibility: "+" },
        { id: "d-data-stream-meth-1", name: "write", returnType: "void", params: ["data: Buffer"], visibility: "+" },
        { id: "d-data-stream-meth-2", name: "close", returnType: "void", params: [], visibility: "+" },
      ],
      x: 300,
      y: 50,
    },
    {
      ...
      stereotype: "class",
      attributes: [
        { id: "d-file-stream-attr-0", name: "filePath", type: "string", visibility: "-" },
        { id: "d-file-stream-attr-1", name: "fileHandle", type: "FileHandle", visibility: "-" },
      ],
      methods: [
        { id: "d-file-stream-meth-0", name: "read", returnType: "Buffer", params: [], visibility: "+" },
        { id: "d-file-stream-meth-1", name: "write", returnType: "void", params: ["data: Buffer"], visibility: "+" },
        { id: "d-file-stream-meth-2", name: "close", returnType: "void", params: [], visibility: "+" },
      ],
      x: 100,
      y: 230,
    },
    {
      id: "d-stream-decorator",
      name: "DataStreamDecorator",
      stereotype: "abstract",
      attributes: [
      ...
      methods: [
        ...
        { id: "d-stream-decorator-meth-1", name: "write", returnType: "void", params: ["data: Buffer"], visibility: "+" },
        { id: "d-stream-decorator-meth-2", name: "close", returnType: "void", params: [], visibility: "+" },
      ],
      x: 500,
      y: 230,
    },
    {
      ...
      methods: [
        ...
        { id: "d-encryption-meth-1", name: "write", returnType: "void", params: ["data: Buffer"], visibility: "+" },
        { id: "d-encryption-meth-2", name: "encrypt", returnType: "Buffer", params: ["data: Buffer"], visibility: "-" },
      ],
      x: 380,
      y: 430,
    },
    {
      ...
      methods: [
        ...
        { id: "d-compression-meth-1", name: "write", returnType: "void", params: ["data: Buffer"], visibility: "+" },
        { id: "d-compression-meth-2", name: "compress", returnType: "Buffer", params: ["data: Buffer"], visibility: "-" },
      ],
      x: 620,
      y: 430,
    },
  ...
  relationships: [
    { id: rid(), source: "d-file-stream", target: "d-data-stream", type: "realization" },
    { id: rid(), source: "d-stream-decorator", target: "d-data-stream", type: "realization" },
    { id: rid(), source: "d-stream-decorator", target: "d-data-stream", type: "aggregation", label: "wraps" },
    { id: rid(), source: "d-encryption", target: "d-stream-decorator", type: "inheritance" },
    { id: rid(), source: "d-compression", target: "d-stream-decorator", type: "inheritance" },
  ],
  code: {
...
const facade: DesignPattern = {
  ...
  classes: [
    {
      ...
      stereotype: "class",
      attributes: [
        { id: "f-order-facade-attr-0", name: "inventory", type: "InventoryService", visibility: "-" },
        { id: "f-order-facade-attr-1", name: "payment", type: "PaymentService", visibility: "-" },
        { id: "f-order-facade-attr-2", name: "shipping", type: "ShippingService", visibility: "-" },
      ],
      methods: [
        { id: "f-order-facade-meth-0", name: "placeOrder", returnType: "OrderConfirmation", params: ["items: CartItem[]", "payment: PaymentInfo"], visibility: "+" },
        { id: "f-order-facade-meth-1", name: "cancelOrder", returnType: "void", params: ["orderId: string"], visibility: "+" },
        { id: "f-order-facade-meth-2", name: "getOrderStatus", returnType: "OrderStatus", params: ["orderId: string"], visibility: "+" },
      ],
      x: 300,
      y: 50,
    },
    {
      ...
      methods: [
        ...
        { id: "f-inventory-meth-1", name: "reserveItems", returnType: "string", params: ["items: CartItem[]"], visibility: "+" },
        { id: "f-inventory-meth-2", name: "releaseReservation", returnType: "void", params: ["reservationId: string"], visibility: "+" },
      ],
      x: 80,
      y: 280,
    },
    {
      ...
      methods: [
        ...
        { id: "f-payment-meth-1", name: "refund", returnType: "void", params: ["transactionId: string"], visibility: "+" },
      ],
      x: 300,
      y: 280,
    },
    {
      ...
      methods: [
        ...
        { id: "f-shipping-meth-1", name: "trackShipment", returnType: "TrackingInfo", params: ["trackingId: string"], visibility: "+" },
        { id: "f-shipping-meth-2", name: "cancelShipment", returnType: "void", params: ["trackingId: string"], visibility: "+" },
      ],
      x: 520,
      y: 280,
    },
  ...
  relationships: [
    { id: rid(), source: "f-order-facade", target: "f-inventory", type: "composition" },
    { id: rid(), source: "f-order-facade", target: "f-payment", type: "composition" },
    { id: rid(), source: "f-order-facade", target: "f-shipping", type: "composition" },
...
const state: DesignPattern = {
  ...
  classes: [
    {
      ...
      attributes: [],
      methods: [
        { id: "st-doc-state-meth-0", name: "edit", returnType: "void", params: ["doc: Document"], visibility: "+" },
        { id: "st-doc-state-meth-1", name: "review", returnType: "void", params: ["doc: Document"], visibility: "+" },
        { id: "st-doc-state-meth-2", name: "publish", returnType: "void", params: ["doc: Document"], visibility: "+" },
        { id: "st-doc-state-meth-3", name: "reject", returnType: "void", params: ["doc: Document"], visibility: "+" },
      ],
      x: 300,
      y: 50,
    },
    {
      ...
      methods: [
        ...
        { id: "st-draft-meth-2", name: "publish", returnType: "void", params: ["doc: Document"], visibility: "+" },
        { id: "st-draft-meth-3", name: "reject", returnType: "void", params: ["doc: Document"], visibility: "+" },
      ],
      x: 50,
      y: 250,
    },
    {
      ...
      methods: [
        ...
        { id: "st-review-meth-2", name: "publish", returnType: "void", params: ["doc: Document"], visibility: "+" },
        { id: "st-review-meth-3", name: "reject", returnType: "void", params: ["doc: Document"], visibility: "+" },
      ],
      x: 300,
      y: 250,
    },
    {
      ...
      methods: [
        ...
        { id: "st-published-meth-2", name: "publish", returnType: "void", params: ["doc: Document"], visibility: "+" },
        { id: "st-published-meth-3", name: "reject", returnType: "void", params: ["doc: Document"], visibility: "+" },
      ],
      x: 550,
      y: 250,
    },
    {
      ...
      stereotype: "class",
      attributes: [
        { id: "st-document-attr-0", name: "state", type: "DocumentState", visibility: "-" },
        { id: "st-document-attr-1", name: "content", type: "string", visibility: "-" },
        { id: "st-document-attr-2", name: "author", type: "string", visibility: "-" },
      ],
      methods: [
        { id: "st-document-meth-0", name: "setState", returnType: "void", params: ["state: DocumentState"], visibility: "+" },
        { id: "st-document-meth-1", name: "edit", returnType: "void", params: [], visibility: "+" },
        { id: "st-document-meth-2", name: "review", returnType: "void", params: [], visibility: "+" },
        { id: "st-document-meth-3", name: "publish", returnType: "void", params: [], visibility: "+" },
      ],
      x: 300,
      y: 460,
    },
  ...
  relationships: [
    { id: rid(), source: "st-draft", target: "st-doc-state", type: "realization" },
    { id: rid(), source: "st-review", target: "st-doc-state", type: "realization" },
    { id: rid(), source: "st-published", target: "st-doc-state", type: "realization" },
...
const proxy: DesignPattern = {
  ...
  classes: [
    {
      ...
      attributes: [],
      methods: [
        { id: "px-image-service-meth-0", name: "loadImage", returnType: "ImageData", params: ["url: string"], visibility: "+" },
        { id: "px-image-service-meth-1", name: "getImage", returnType: "ImageData | null", params: ["url: string"], visibility: "+" },
      ],
      x: 300,
      y: 50,
    },
    {
      id: "px-remote-service",
      name: "RemoteImageService",
      stereotype: "class",
      attributes: [
        { id: "px-remote-service-attr-0", name: "apiBaseUrl", type: "string", visibility: "-" },
        { id: "px-remote-service-attr-1", name: "authToken", type: "string", visibility: "-" },
      ],
      methods: [
        { id: "px-remote-service-meth-0", name: "loadImage", returnType: "ImageData", params: ["url: string"], visibility: "+" },
        { id: "px-remote-service-meth-1", name: "getImage", returnType: "ImageData | null", params: ["url: string"], visibility: "+" },
      ],
      x: 120,
      y: 280,
    },
    {
      id: "px-cached-proxy",
      name: "CachedImageProxy",
      stereotype: "class",
      attributes: [
        { id: "px-cached-proxy-attr-0", name: "realService", type: "RemoteImageService", visibility: "-" },
        { id: "px-cached-proxy-attr-1", name: "cache", type: "Map<string, ImageData>", visibility: "-" },
        { id: "px-cached-proxy-attr-2", name: "ttlMs", type: "number", visibility: "-" },
      ],
      methods: [
        { id: "px-cached-proxy-meth-0", name: "loadImage", returnType: "ImageData", params: ["url: string"], visibility: "+" },
        { id: "px-cached-proxy-meth-1", name: "getImage", returnType: "ImageData | null", params: ["url: string"], visibility: "+" },
        { id: "px-cached-proxy-meth-2", name: "clearCache", returnType: "void", params: [], visibility: "+" },
        { id: "px-cached-proxy-meth-3", name: "isCached", returnType: "boolean", params: ["url: string"], visibility: "-" },
      ],
      x: 480,
      y: 280,
    },
  ...
  relationships: [
    { id: rid(), source: "px-remote-service", target: "px-image-service", type: "realization" },
    { id: rid(), source: "px-cached-proxy", target: "px-image-service", type: "realization" },
    { id: rid(), source: "px-cached-proxy", target: "px-remote-service", type: "association", label: "delegates to" },
...
const iterator: DesignPattern = {
  ...
  classes: [
    {
      ...
      attributes: [],
      methods: [
        { id: "it-song-iterator-meth-0", name: "hasNext", returnType: "boolean", params: [], visibility: "+" },
        { id: "it-song-iterator-meth-1", name: "next", returnType: "Song", params: [], visibility: "+" },
        { id: "it-song-iterator-meth-2", name: "reset", returnType: "void", params: [], visibility: "+" },
      ],
      x: 400,
      y: 50,
    },
    {
      ...
      stereotype: "class",
      attributes: [
        { id: "it-playlist-attr-0", name: "songs", type: "Song[]", visibility: "-" },
        { id: "it-playlist-attr-1", name: "name", type: "string", visibility: "-" },
      ],
      methods: [
        { id: "it-playlist-meth-0", name: "createIterator", returnType: "SongIterator", params: [], visibility: "+" },
        { id: "it-playlist-meth-1", name: "createShuffleIterator", returnType: "SongIterator", params: [], visibility: "+" },
        { id: "it-playlist-meth-2", name: "addSong", returnType: "void", params: ["song: Song"], visibility: "+" },
        { id: "it-playlist-meth-3", name: "getSongs", returnType: "Song[]", params: [], visibility: "+" },
      ],
      x: 100,
      y: 50,
    },
    {
      ...
      stereotype: "class",
      attributes: [
        { id: "it-song-attr-0", name: "title", type: "string", visibility: "-" },
        { id: "it-song-attr-1", name: "artist", type: "string", visibility: "-" },
        { id: "it-song-attr-2", name: "durationMs", type: "number", visibility: "-" },
      ],
      methods: [
        { id: "it-song-meth-0", name: "getTitle", returnType: "string", params: [], visibility: "+" },
        { id: "it-song-meth-1", name: "getArtist", returnType: "string", params: [], visibility: "+" },
      ],
      x: 100,
      y: 280,
    },
    {
      id: "it-playlist-iterator",
      name: "PlaylistIterator",
      stereotype: "class",
      attributes: [
        { id: "it-playlist-iterator-attr-0", name: "playlist", type: "Playlist", visibility: "-" },
        { id: "it-playlist-iterator-attr-1", name: "position", type: "number", visibility: "-" },
      ],
      methods: [
        { id: "it-playlist-iterator-meth-0", name: "hasNext", returnType: "boolean", params: [], visibility: "+" },
        { id: "it-playlist-iterator-meth-1", name: "next", returnType: "Song", params: [], visibility: "+" },
        { id: "it-playlist-iterator-meth-2", name: "reset", returnType: "void", params: [], visibility: "+" },
      ],
      x: 400,
      y: 280,
    },
    {
      id: "it-shuffle-iterator",
      name: "ShuffleIterator",
      stereotype: "class",
      attributes: [
        { id: "it-shuffle-iterator-attr-0", name: "playlist", type: "Playlist", visibility: "-" },
        { id: "it-shuffle-iterator-attr-1", name: "shuffledIndices", type: "number[]", visibility: "-" },
      ],
      methods: [
        { id: "it-shuffle-iterator-meth-0", name: "hasNext", returnType: "boolean", params: [], visibility: "+" },
        { id: "it-shuffle-iterator-meth-1", name: "next", returnType: "Song", params: [], visibility: "+" },
        { id: "it-shuffle-iterator-meth-2", name: "reset", returnType: "void", params: [], visibility: "+" },
      ],
      x: 600,
      y: 280,
    },
  ...
  relationships: [
    { id: rid(), source: "it-playlist-iterator", target: "it-song-iterator", type: "realization" },
    { id: rid(), source: "it-shuffle-iterator", target: "it-song-iterator", type: "realization" },
    { id: rid(), source: "it-playlist", target: "it-song-iterator", type: "dependency", label: "creates" },
    { id: rid(), source: "it-playlist-iterator", target: "it-playlist", type: "association", label: "traverses" },
    { id: rid(), source: "it-shuffle-iterator", target: "it-playlist", type: "association", label: "traverses" },
...
const mediator: DesignPattern = {
  ...
  classes: [
    {
      id: "med-chat-mediator",
      name: "ChatMediator",
      stereotype: "interface",
      attributes: [],
      methods: [
        { id: "med-chat-mediator-meth-0", name: "sendMessage", returnType: "void", params: ["sender: ChatUser", "message: string"], visibility: "+" },
        { id: "med-chat-mediator-meth-1", name: "addUser", returnType: "void", params: ["user: ChatUser"], visibility: "+" },
        { id: "med-chat-mediator-meth-2", name: "removeUser", returnType: "void", params: ["user: ChatUser"], visibility: "+" },
      ],
      x: 300,
      y: 50,
    },
    {
      ...
      stereotype: "class",
      attributes: [
        { id: "med-group-chat-attr-0", name: "users", type: "ChatUser[]", visibility: "-" },
        { id: "med-group-chat-attr-1", name: "roomName", type: "string", visibility: "-" },
        { id: "med-group-chat-attr-2", name: "messageHistory", type: "Message[]", visibility: "-" },
      ],
      methods: [
        { id: "med-group-chat-meth-0", name: "sendMessage", returnType: "void", params: ["sender: ChatUser", "message: string"], visibility: "+" },
        { id: "med-group-chat-meth-1", name: "addUser", returnType: "void", params: ["user: ChatUser"], visibility: "+" },
        { id: "med-group-chat-meth-2", name: "removeUser", returnType: "void", params: ["user: ChatUser"], visibility: "+" },
        { id: "med-group-chat-meth-3", name: "getHistory", returnType: "Message[]", params: [], visibility: "+" },
      ],
      x: 300,
      y: 250,
    },
    {
      ...
      stereotype: "abstract",
      attributes: [
        { id: "med-chat-user-attr-0", name: "mediator", type: "ChatMediator", visibility: "#" },
        { id: "med-chat-user-attr-1", name: "username", type: "string", visibility: "#" },
      ],
      methods: [
        { id: "med-chat-user-meth-0", name: "setMediator", returnType: "void", params: ["mediator: ChatMediator"], visibility: "+" },
        { id: "med-chat-user-meth-1", name: "sendMessage", returnType: "void", params: ["message: string"], visibility: "+" },
        { id: "med-chat-user-meth-2", name: "receiveMessage", returnType: "void", params: ["from: string", "message: string"], visibility: "+" },
      ],
      x: 300,
      y: 460,
    },
    {
      ...
      methods: [
        ...
        { id: "med-admin-user-meth-2", name: "kickUser", returnType: "void", params: ["username: string"], visibility: "+" },
      ],
      x: 100,
      y: 660,
    },
  ...
  relationships: [
    { id: rid(), source: "med-group-chat", target: "med-chat-mediator", type: "realization" },
    { id: rid(), source: "med-admin-user", target: "med-chat-user", type: "inheritance" },
    { id: rid(), source: "med-regular-user", target: "med-chat-user", type: "inheritance" },
    { id: rid(), source: "med-chat-user", target: "med-chat-mediator", type: "association", label: "communicates via" },
    { id: rid(), source: "med-group-chat", target: "med-admin-user", type: "association", label: "coordinates" },
...
const templateMethod: DesignPattern = {
  ...
  classes: [
    {
      ...
      methods: [
        ...
        { id: "tm-data-exporter-meth-1", name: "formatHeader", returnType: "string", params: ["columns: string[]"], visibility: "#", isAbstract: true },
        { id: "tm-data-exporter-meth-2", name: "formatRow", returnType: "string", params: ["row: Record"], visibility: "#", isAbstract: true },
        { id: "tm-data-exporter-meth-3", name: "writeOutput", returnType: "Buffer", params: ["content: string"], visibility: "#", isAbstract: true },
        { id: "tm-data-exporter-meth-4", name: "addFooter", returnType: "string", params: [], visibility: "#" },
      ],
      x: 300,
      y: 50,
    },
    {
      ...
      methods: [
        ...
        { id: "tm-csv-exporter-meth-1", name: "formatRow", returnType: "string", params: ["row: Record"], visibility: "#" },
        { id: "tm-csv-exporter-meth-2", name: "writeOutput", returnType: "Buffer", params: ["content: string"], visibility: "#" },
      ],
      x: 120,
      y: 320,
    },
    {
      ...
      stereotype: "class",
      attributes: [
        { id: "tm-pdf-exporter-attr-0", name: "pageSize", type: "string", visibility: "-" },
        { id: "tm-pdf-exporter-attr-1", name: "orientation", type: "string", visibility: "-" },
      ],
      methods: [
        { id: "tm-pdf-exporter-meth-0", name: "formatHeader", returnType: "string", params: ["columns: string[]"], visibility: "#" },
        { id: "tm-pdf-exporter-meth-1", name: "formatRow", returnType: "string", params: ["row: Record"], visibility: "#" },
        { id: "tm-pdf-exporter-meth-2", name: "writeOutput", returnType: "Buffer", params: ["content: string"], visibility: "#" },
        { id: "tm-pdf-exporter-meth-3", name: "addFooter", returnType: "string", params: [], visibility: "#" },
      ],
      x: 480,
      y: 320,
    },
  ...
  relationships: [
    { id: rid(), source: "tm-csv-exporter", target: "tm-data-exporter", type: "inheritance" },
    { id: rid(), source: "tm-pdf-exporter", target: "tm-data-exporter", type: "inheritance" },
  ],
  code: {
  ...
  classes: [
    {
      ...
      attributes: [],
      methods: [
        { id: "cp-fs-node-meth-0", name: "getSize", returnType: "number", params: [], visibility: "+" },
        { id: "cp-fs-node-meth-1", name: "getName", returnType: "string", params: [], visibility: "+" },
        { id: "cp-fs-node-meth-2", name: "print", returnType: "void", params: ["indent: string"], visibility: "+" },
        { id: "cp-fs-node-meth-3", name: "getPath", returnType: "string", params: [], visibility: "+" },
      ],
      x: 300,
      y: 50,
    },
    {
      ...
      stereotype: "class",
      attributes: [
        { id: "cp-file-attr-0", name: "name", type: "string", visibility: "-" },
        { id: "cp-file-attr-1", name: "size", type: "number", visibility: "-" },
        { id: "cp-file-attr-2", name: "extension", type: "string", visibility: "-" },
      ],
      methods: [
        { id: "cp-file-meth-0", name: "getSize", returnType: "number", params: [], visibility: "+" },
        { id: "cp-file-meth-1", name: "getName", returnType: "string", params: [], visibility: "+" },
        { id: "cp-file-meth-2", name: "print", returnType: "void", params: ["indent: string"], visibility: "+" },
        { id: "cp-file-meth-3", name: "getPath", returnType: "string", params: [], visibility: "+" },
      ],
      x: 100,
      y: 280,
    },
    {
      ...
      stereotype: "class",
      attributes: [
        { id: "cp-directory-attr-0", name: "name", type: "string", visibility: "-" },
        { id: "cp-directory-attr-1", name: "children", type: "FileSystemNode[]", visibility: "-" },
      ],
      methods: [
        { id: "cp-directory-meth-0", name: "getSize", returnType: "number", params: [], visibility: "+" },
        { id: "cp-directory-meth-1", name: "getName", returnType: "string", params: [], visibility: "+" },
        { id: "cp-directory-meth-2", name: "print", returnType: "void", params: ["indent: string"], visibility: "+" },
        { id: "cp-directory-meth-3", name: "getPath", returnType: "string", params: [], visibility: "+" },
        { id: "cp-directory-meth-4", name: "add", returnType: "void", params: ["child: FileSystemNode"], visibility: "+" },
        { id: "cp-directory-meth-5", name: "remove", returnType: "void", params: ["child: FileSystemNode"], visibility: "+" },
      ],
      x: 500,
      y: 280,
    },
...
const chainOfResponsibility: DesignPattern = {
  ...
  classes: [
    {
      ...
      methods: [
        ...
        { id: "cor-support-handler-meth-1", name: "handle", returnType: "string | null", params: ["ticket: SupportTicket"], visibility: "+" },
        { id: "cor-support-handler-meth-2", name: "canHandle", returnType: "boolean", params: ["ticket: SupportTicket"], visibility: "#", isAbstract: true },
      ],
      x: 300,
      y: 50,
    },
    {
      ...
      methods: [
        ...
        { id: "cor-technical-meth-1", name: "canHandle", returnType: "boolean", params: ["ticket: SupportTicket"], visibility: "#" },
      ],
      x: 50,
      y: 280,
    },
    {
      ...
      methods: [
        ...
        { id: "cor-billing-meth-1", name: "canHandle", returnType: "boolean", params: ["ticket: SupportTicket"], visibility: "#" },
      ],
      x: 300,
      y: 280,
    },
    {
      ...
      methods: [
        ...
        { id: "cor-manager-meth-1", name: "canHandle", returnType: "boolean", params: ["ticket: SupportTicket"], visibility: "#" },
      ],
      x: 550,
      y: 280,
    },
    {
      ...
      stereotype: "class",
      attributes: [
        { id: "cor-ticket-attr-0", name: "category", type: "string", visibility: "-" },
        { id: "cor-ticket-attr-1", name: "priority", type: "string", visibility: "-" },
        { id: "cor-ticket-attr-2", name: "description", type: "string", visibility: "-" },
      ],
      methods: [
        { id: "cor-ticket-meth-0", name: "getCategory", returnType: "string", params: [], visibility: "+" },
        { id: "cor-ticket-meth-1", name: "getPriority", returnType: "string", params: [], visibility: "+" },
      ],
      x: 300,
      y: -120,
    },
  ...
  relationships: [
    { id: rid(), source: "cor-technical", target: "cor-support-handler", type: "inheritance" },
    { id: rid(), source: "cor-billing", target: "cor-support-handler", type: "inheritance" },
    { id: rid(), source: "cor-manager", target: "cor-support-handler", type: "inheritance" },
    { id: rid(), source: "cor-support-handler", target: "cor-support-handler", type: "association", label: "next" },
    { id: rid(), source: "cor-support-handler", target: "cor-ticket", type: "dependency", label: "handles" },
  ],
  code: {
...
const memento: DesignPattern = {
  ...
  classes: [
    {
      ...
      stereotype: "class",
      attributes: [
        { id: "mem-editor-attr-0", name: "content", type: "string", visibility: "-" },
        { id: "mem-editor-attr-1", name: "cursorPosition", type: "number", visibility: "-" },
        { id: "mem-editor-attr-2", name: "selectionStart", type: "number", visibility: "-" },
      ],
      methods: [
        { id: "mem-editor-meth-0", name: "save", returnType: "EditorSnapshot", params: [], visibility: "+" },
        { id: "mem-editor-meth-1", name: "restore", returnType: "void", params: ["snapshot: EditorSnapshot"], visibility: "+" },
        { id: "mem-editor-meth-2", name: "setContent", returnType: "void", params: ["content: string"], visibility: "+" },
        { id: "mem-editor-meth-3", name: "getContent", returnType: "string", params: [], visibility: "+" },
        { id: "mem-editor-meth-4", name: "insertText", returnType: "void", params: ["text: string", "position: number"], visibility: "+" },
      ],
      x: 300,
      y: 50,
    },
    {
      ...
      stereotype: "class",
      attributes: [
        { id: "mem-snapshot-attr-0", name: "content", type: "string", visibility: "-" },
        { id: "mem-snapshot-attr-1", name: "cursorPosition", type: "number", visibility: "-" },
        { id: "mem-snapshot-attr-2", name: "timestamp", type: "Date", visibility: "-" },
      ],
      methods: [
        { id: "mem-snapshot-meth-0", name: "getContent", returnType: "string", params: [], visibility: "-" },
        { id: "mem-snapshot-meth-1", name: "getCursorPosition", returnType: "number", params: [], visibility: "-" },
        { id: "mem-snapshot-meth-2", name: "getTimestamp", returnType: "Date", params: [], visibility: "+" },
      ],
      x: 300,
      y: 280,
    },
    {
      ...
      stereotype: "class",
      attributes: [
        { id: "mem-undo-history-attr-0", name: "undoStack", type: "EditorSnapshot[]", visibility: "-" },
        { id: "mem-undo-history-attr-1", name: "redoStack", type: "EditorSnapshot[]", visibility: "-" },
        { id: "mem-undo-history-attr-2", name: "editor", type: "TextEditor", visibility: "-" },
      ],
      methods: [
        { id: "mem-undo-history-meth-0", name: "backup", returnType: "void", params: [], visibility: "+" },
        { id: "mem-undo-history-meth-1", name: "undo", returnType: "void", params: [], visibility: "+" },
        { id: "mem-undo-history-meth-2", name: "redo", returnType: "void", params: [], visibility: "+" },
        { id: "mem-undo-history-meth-3", name: "showHistory", returnType: "void", params: [], visibility: "+" },
      ],
      x: 600,
      y: 50,
    },
  ...
  relationships: [
    { id: rid(), source: "mem-editor", target: "mem-snapshot", type: "dependency", label: "creates" },
    { id: rid(), source: "mem-undo-history", target: "mem-snapshot", type: "aggregation", label: "stores" },
    { id: rid(), source: "mem-undo-history", target: "mem-editor", type: "association", label: "uses" },
  ],
  code: {
...
const visitor: DesignPattern = {
  ...
  classes: [
    {
      ...
      attributes: [],
      methods: [
        { id: "vis-node-visitor-meth-0", name: "visitNumber", returnType: "string", params: ["node: NumberLiteral"], visibility: "+" },
        { id: "vis-node-visitor-meth-1", name: "visitBinaryExpr", returnType: "string", params: ["node: BinaryExpression"], visibility: "+" },
      ],
      x: 100,
      y: 50,
    },
    {
      ...
      methods: [
        ...
        { id: "vis-type-checker-meth-1", name: "visitBinaryExpr", returnType: "string", params: ["node: BinaryExpression"], visibility: "+" },
        { id: "vis-type-checker-meth-2", name: "check", returnType: "string[]", params: ["root: ASTNode"], visibility: "+" },
      ],
      x: 50,
      y: 270,
    },
    {
      id: "vis-code-generator",
      name: "CodeGenerator",
      stereotype: "class",
      attributes: [
      ...
      methods: [
        ...
        { id: "vis-code-generator-meth-1", name: "visitBinaryExpr", returnType: "string", params: ["node: BinaryExpression"], visibility: "+" },
        { id: "vis-code-generator-meth-2", name: "generate", returnType: "string", params: ["root: ASTNode"], visibility: "+" },
      ],
      x: 250,
      y: 270,
    },
    {
      ...
      attributes: [],
      methods: [
        { id: "vis-ast-node-meth-0", name: "accept", returnType: "string", params: ["visitor: NodeVisitor"], visibility: "+" },
      ],
      x: 500,
      y: 50,
    },
    {
      id: "vis-number-literal",
      name: "NumberLiteral",
      stereotype: "class",
      attributes: [
        { id: "vis-number-literal-attr-0", name: "value", type: "number", visibility: "-" },
        { id: "vis-number-literal-attr-1", name: "line", type: "number", visibility: "-" },
      ],
      methods: [
        { id: "vis-number-literal-meth-0", name: "accept", returnType: "string", params: ["visitor: NodeVisitor"], visibility: "+" },
        { id: "vis-number-literal-meth-1", name: "getValue", returnType: "number", params: [], visibility: "+" },
      ],
      x: 450,
      y: 270,
    },
    {
      ...
      stereotype: "class",
      attributes: [
        { id: "vis-binary-expr-attr-0", name: "operator", type: "string", visibility: "-" },
        { id: "vis-binary-expr-attr-1", name: "left", type: "ASTNode", visibility: "-" },
        { id: "vis-binary-expr-attr-2", name: "right", type: "ASTNode", visibility: "-" },
      ],
      methods: [
        { id: "vis-binary-expr-meth-0", name: "accept", returnType: "string", params: ["visitor: NodeVisitor"], visibility: "+" },
        { id: "vis-binary-expr-meth-1", name: "getOperator", returnType: "string", params: [], visibility: "+" },
      ],
      x: 650,
      y: 270,
    },
  ...
  relationships: [
    { id: rid(), source: "vis-type-checker", target: "vis-node-visitor", type: "realization" },
    { id: rid(), source: "vis-code-generator", target: "vis-node-visitor", type: "realization" },
    { id: rid(), source: "vis-number-literal", target: "vis-ast-node", type: "realization" },
    { id: rid(), source: "vis-binary-expr", target: "vis-ast-node", type: "realization" },
    { id: rid(), source: "vis-node-visitor", target: "vis-ast-node", type: "dependency", label: "visits" },
  ],
  code: {
...
const prototype: DesignPattern = {
  ...
  classes: [
    {
      id: "proto-ui-component",
      name: "UIComponent",
      stereotype: "interface",
      attributes: [],
      methods: [
        { id: "proto-ui-component-meth-0", name: "clone", returnType: "UIComponent", params: [], visibility: "+" },
        { id: "proto-ui-component-meth-1", name: "render", returnType: "string", params: [], visibility: "+" },
      ],
      x: 300,
      y: 50,
    },
    {
      ...
      stereotype: "class",
      attributes: [
        { id: "proto-button-attr-0", name: "label", type: "string", visibility: "-" },
        { id: "proto-button-attr-1", name: "style", type: "ButtonStyle", visibility: "-" },
        { id: "proto-button-attr-2", name: "onClick", type: "Function", visibility: "-" },
      ],
      methods: [
        { id: "proto-button-meth-0", name: "clone", returnType: "UIComponent", params: [], visibility: "+" },
        { id: "proto-button-meth-1", name: "render", returnType: "string", params: [], visibility: "+" },
        { id: "proto-button-meth-2", name: "setStyle", returnType: "void", params: ["style: ButtonStyle"], visibility: "+" },
      ],
      x: 120,
      y: 270,
    },
    {
      ...
      stereotype: "class",
      attributes: [
        { id: "proto-modal-attr-0", name: "title", type: "string", visibility: "-" },
        { id: "proto-modal-attr-1", name: "content", type: "string", visibility: "-" },
        { id: "proto-modal-attr-2", name: "style", type: "ModalStyle", visibility: "-" },
      ],
      methods: [
        { id: "proto-modal-meth-0", name: "clone", returnType: "UIComponent", params: [], visibility: "+" },
        { id: "proto-modal-meth-1", name: "render", returnType: "string", params: [], visibility: "+" },
        { id: "proto-modal-meth-2", name: "setStyle", returnType: "void", params: ["style: ModalStyle"], visibility: "+" },
      ],
      x: 480,
      y: 270,
    },
  ...
  relationships: [
    { id: rid(), source: "proto-button", target: "proto-ui-component", type: "realization" },
    { id: rid(), source: "proto-modal", target: "proto-ui-component", type: "realization" },
  ],
  code: {
  ...
  classes: [
    {
      ...
      stereotype: "abstract",
      attributes: [
        { id: "br-notification-attr-0", name: "sender", type: "MessageSender", visibility: "#" },
        { id: "br-notification-attr-1", name: "title", type: "string", visibility: "#" },
      ],
      methods: [
        { id: "br-notification-meth-0", name: "send", returnType: "void", params: ["message: string"], visibility: "+" },
        { id: "br-notification-meth-1", name: "formatMessage", returnType: "string", params: ["message: string"], visibility: "#" },
      ],
      x: 120,
      y: 50,
    },
    {
      ...
      methods: [
        ...
        { id: "br-urgent-meth-1", name: "formatMessage", returnType: "string", params: ["message: string"], visibility: "#" },
      ],
      x: 120,
      y: 280,
    },
    {
      id: "br-message-sender",
      name: "MessageSender",
      stereotype: "interface",
      attributes: [],
      methods: [
        { id: "br-message-sender-meth-0", name: "deliver", returnType: "void", params: ["title: string", "body: string"], visibility: "+" },
        { id: "br-message-sender-meth-1", name: "isAvailable", returnType: "boolean", params: [], visibility: "+" },
      ],
      x: 480,
      y: 50,
    },
    {
      ...
      stereotype: "class",
      attributes: [
        { id: "br-email-sender-attr-0", name: "smtpHost", type: "string", visibility: "-" },
        { id: "br-email-sender-attr-1", name: "fromAddress", type: "string", visibility: "-" },
      ],
      methods: [
        { id: "br-email-sender-meth-0", name: "deliver", returnType: "void", params: ["title: string", "body: string"], visibility: "+" },
        { id: "br-email-sender-meth-1", name: "isAvailable", returnType: "boolean", params: [], visibility: "+" },
      ],
      x: 380,
      y: 280,
    },
    {
      ...
      stereotype: "class",
      attributes: [
        { id: "br-slack-sender-attr-0", name: "webhookUrl", type: "string", visibility: "-" },
        { id: "br-slack-sender-attr-1", name: "channel", type: "string", visibility: "-" },
      ],
      methods: [
        { id: "br-slack-sender-meth-0", name: "deliver", returnType: "void", params: ["title: string", "body: string"], visibility: "+" },
        { id: "br-slack-sender-meth-1", name: "isAvailable", returnType: "boolean", params: [], visibility: "+" },
      ],
      x: 580,
      y: 280,
    },
  ...
  classes: [
    ...
    },
    {
      ...
      attributes: [
        ...
        { id: "cb-config-attr-3", name: "monitorIntervalMs", type: "number", visibility: "+" },
      ],
      methods: [
    ...
    },
    {
      ...
      methods: [
        ...
        { id: "cb-class-meth-6", name: "reset", returnType: "void", params: [], visibility: "+" },
        { id: "cb-class-meth-7", name: "getMetrics", returnType: "CircuitBreakerMetrics", params: [], visibility: "+" },
      ],
      x: 200,
      y: 250,
    },
...
const flyweight: DesignPattern = {
  ...
  classes: [
    ...
    },
    {
      ...
      stereotype: "class",
      attributes: [
        { id: "fw-font-glyph-attr-0", name: "fontFamily", type: "string", visibility: "-" },
        { id: "fw-font-glyph-attr-1", name: "fontWeight", type: "number", visibility: "-" },
        { id: "fw-font-glyph-attr-2", name: "color", type: "string", visibility: "-" },
      ],
      methods: [
        { id: "fw-font-glyph-meth-0", name: "render", returnType: "void", params: ["position: Point", "fontSize: number"], visibility: "+" },
        { id: "fw-font-glyph-meth-1", name: "getKey", returnType: "string", params: [], visibility: "+" },
      ],
      x: 150,
      y: 250,
    },
    {
      id: "fw-formatted-char",
      name: "FormattedCharacter",
      stereotype: "class",
      attributes: [
        { id: "fw-formatted-char-attr-0", name: "character", type: "string", visibility: "-" },
        { id: "fw-formatted-char-attr-1", name: "glyph", type: "CharacterGlyph", visibility: "-" },
        { id: "fw-formatted-char-attr-2", name: "decoration", type: "string", visibility: "-" },
      ],
      methods: [
    ...
    },
    {
      ...
      methods: [
        ...
        { id: "fw-glyph-factory-meth-1", name: "getCacheSize", returnType: "number", params: [], visibility: "+" },
      ],
      x: 300,
      y: 430,
    },
