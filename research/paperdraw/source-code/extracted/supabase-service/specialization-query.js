...
$iaTJ:1}
A.aUF.prototype={
$1(a){return a.b===J.aa(this.a,"component_type")},
$S:16}
A.aUA.prototype={
$1(a){return a.b},
$S:78}
A.aUv.prototype={
$0(){var s=0,r=A.A(t.fO),q,p=2,o=[],n=this,m,l,k,j,i,h
var $async$$0=A.w(function(a,b){if(a===1){o.push(b)
...
k=n.b
j=A.v(k).i("q<1,O<c,R?>>")
k=A.r(new A.q(k,new A.aUu(n.a,n.c),j),j.i("a2.E"))
k.$flags=1
s=7
return A.n(l.kL("ensure-specialization-drafts",A.u(["components",k],t.N,t.E0)),$async$$0)
case 7:l=b
q=l
s=1
break
...
$S:351}
A.aUu.prototype={
$1(a){var s,r=A.j(t.N,t.X)
J.bP(r,"componentType",a.b)
J.bP(r,"category",a.gbD().b)
J.bP(r,"displayName",a.c)
J.